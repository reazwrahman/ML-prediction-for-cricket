...
filenames = ["Men T20I Player Innings Stats - 2021.csv", "Men T20I Player Innings Stats - 2022.csv", 
...
df['strike_rate'] = df.apply(lambda row: row['runs']*100 if pd.isna(row['strike_rate']) else row['strike_rate'], axis=1)
